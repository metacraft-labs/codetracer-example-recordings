...
#
# This script:
#   1. Compiles the CTSP client for the iOS simulator target
#   2. Builds the stream-receiver helper on the Mac
#   3. Spawns the binary on the simulator and receives the trace
#
...
# Copy binary into simulator's data directory and spawn it
