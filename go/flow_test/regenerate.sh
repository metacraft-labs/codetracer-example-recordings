#!/usr/bin/env bash
# Regenerate the Go RR flow_test recording fixture.
#
...
# canonical id GO_FLOW_TEST_RECORDING_ID below is pinned consumer-side
...
#   direnv exec ../codetracer bash go/flow_test/regenerate.sh
...
GO_FLOW_TEST_RECORDING_ID="019e3a35-2531-7600-8aaa-43ff10020001"

SOURCE="$CODETRACER/src/db-backend/test-programs/go/go_flow_program.go"
BUILT="/tmp/go_flow_program"
OUT_DIR="$SCRIPT_DIR"

echo "=== Regenerating Go RR flow_test fixture ==="
echo "  Source:       $SOURCE"
echo "  Built binary: $BUILT"
echo "  Output dir:   $OUT_DIR"
echo "  recording_id: $GO_FLOW_TEST_RECORDING_ID (pinned consumer-side)"
echo ""
