#!/usr/bin/env bash
# Regenerate the Rust RR flow_test recording fixture.
#
...
# canonical id RUST_FLOW_TEST_RECORDING_ID below is pinned consumer-side
...
#   direnv exec ../codetracer bash rust/flow_test/regenerate.sh
...
RUST_FLOW_TEST_RECORDING_ID="019e3a35-2536-7900-8aaa-43ff10070001"

SOURCE="$CODETRACER/src/db-backend/test-programs/rust/rust_flow_test.rs"
BUILT="/tmp/rust_flow_test"
OUT_DIR="$SCRIPT_DIR"

echo "=== Regenerating Rust RR flow_test fixture ==="
echo "  Source:       $SOURCE"
echo "  Built binary: $BUILT"
echo "  Output dir:   $OUT_DIR"
echo "  recording_id: $RUST_FLOW_TEST_RECORDING_ID (pinned consumer-side)"
echo ""
