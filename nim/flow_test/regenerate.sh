#!/usr/bin/env bash
# Regenerate the Nim RR flow_test recording fixture.
#
...
# canonical id NIM_FLOW_TEST_RECORDING_ID below is pinned consumer-side
...
#   direnv exec ../codetracer bash nim/flow_test/regenerate.sh
...
NIM_FLOW_TEST_RECORDING_ID="019e3a35-2533-7e00-8aaa-43ff10040001"

SOURCE="$CODETRACER/src/db-backend/test-programs/nim/nim_flow_test.nim"
BUILT="/tmp/nim_flow_test"
OUT_DIR="$SCRIPT_DIR"

echo "=== Regenerating Nim RR flow_test fixture ==="
echo "  Source:       $SOURCE"
echo "  Built binary: $BUILT"
echo "  Output dir:   $OUT_DIR"
echo "  recording_id: $NIM_FLOW_TEST_RECORDING_ID (pinned consumer-side)"
echo ""
