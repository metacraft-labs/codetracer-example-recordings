...
| `mcr/linux-arm64/trace.ct`                   | `019e3a35-2541-7a00-8aaa-43ff20020001`   | **Not yet recorded** (placeholder ID reserved). README documents Linux ARM64 as a planned platform.                                                    |
| `mcr/linux-arm64/trace-portable.ct`          | `019e3a35-2541-7a00-8aaa-43ff20020002`   | Reserved alongside the raw entry above.                                                                                                                |
